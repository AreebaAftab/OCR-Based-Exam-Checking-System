				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a href="#services_bg" class="hvr-underline-from-center scroll">Services</a></li>
							<li><a href="sign-up-form/signin.php">Login</a></li>
						</ul>
					</div>
				...
				<ul class="rslides" id="slider3">
					...
					<li>
						...
						<div class="slider-info">
							 <h3><span>Smart Way To</span></h3>
						
							<h4><span style="color:orange">Check Exam Sheets</span></h4>
					...
					<li>
						...
						<div class="slider-info">
							 <h3><span>Check and Grade</span></h3>
						
							<h4><span style="color:orange">With No time</span></h4>
...
<!--/about -->
					...
					<div class="container">
								 ...
								 <div class="wthree-about"> 
									 ...
									 <div class="col-md-6 ab-w3l-text">
									   <h2><span class="opening">ABOUT US</span></h2>
									   <p>In this era of Digital world, checking exam sheets manually is something wildly unreasonable, Since it takes a lot of time in scrutinizing exam sheets and grading the whole class. We provide an entire procedure computerized. Our service will automatically point out mistakes in student's exam sheet and will grade it accordingly. </p>
									</div>
									<div class="col-md-6 about-w3l-agileifo-grid">
				                          <img src="images/about_img.jpg" alt=" " class="img-responsive">
										  <div class="img-ab"> <img src="images/slider1.png" alt=" " class="img-responsive"></div>
				                    </div>
									<div class="clearfix"> </div>
	  ...
	  <div class="agile-services-w3">
				<div class="container" id="services_bg">
				     <h3 class="tittle ser"><span class="opening">OUR SERVICES</span> </h3>
    ...
    <h3 class="tittle">DELICIOUS MENU</h3>
      <div class="agileits-tabs">
	      <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
						...
						<li role="presentation" class="active"><a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">BREAKFAST</a></li>
						<li role="presentation"><a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile" aria-expanded="false">LUNCH</a></li>
						<li role="presentation"><a href="#rating" id="rating-tab" role="tab" data-toggle="tab" aria-controls="rating" aria-expanded="true">DINNER</a></li>
						<li role="presentation"><a href="#imdb" role="tab" id="imdb-tab" data-toggle="tab" aria-controls="imdb" aria-expanded="false">DRINKS</a></li>
						</ul>
			...
			<div class="gallery_gds">
				<div class="col-md-4 gal-w3l">
						<div class="agileits-img">
							<a href="images/slider1.png" class="swipebox" title="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis maximus tortor diam, ac lobortis justo rutrum quis. Praesent non purus fermentum, eleifend velit non">
								<img class="img-responsive img-style row2" src="images/slider1.png" alt=""  /> 
							</a> 
						</div>
					</div>
					<div class="col-md-4 gal-w3l">
		...
		<h3 class="tittle">BOOK YOUR TABLE</h3>
			<div class="agile-reservation">
			    <div class="col-md-4 agile-reservation-grid">
			        <img src="images/r1.jpg" alt=" " class="img-responsive img-style row2">
			    </div>
	...
	<div class="w3l-footer">
		<div class="container">
		 ...
		 <div class="col-md-4 footer-info-grid address">
					<h4><span class="opening">N</span>avigations</h4>
				...
				<h4><span class="opening">S</span>upport</h4>
						<address>
						<ul>
							<li>Help</li>
							<li>Integration</li>
							
							<li>Manual and Guides</li>
							<li>Log in</li>
				...
				<h4> <span class="opening">C</span>onnect with <span class="opening">Us </span></h4>
		...
		<div class="copyright-wthree">
				<p>&copy; 2018 Exam Checker. All Rights Reserved </p>
			</div>
	</div>
